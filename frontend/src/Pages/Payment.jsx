            ...
            <Box className='payment-left-container'>
                <Box className='creditcard-container'>
                    ...
                    <Box className='creditcard-form'>
                        ...
                        <Box display={'flex'} justifyContent='space-between'>
                            <Input className='inputbox' placeholder='Card Number' width={['200px', '230px', '250px']} />
                            <Box display={'flex'} alignItems='center' justifyContent={'center'} border={'1px solid #d0d0d0'}>
                                <input style={{ width: '60px' }} placeholder='CVV' />
                                <Image src='https://media6.ppl-media.com/mediafiles/ecomm/misc/1516175146_cvv.jpg' alt='cvv' width={'30px'} height='20px' />
                            </Box>
                        </Box>
                        <Box display={'flex'} justifyContent='space-between'>
                ...
                <Box className='creditcard-container'>
                    ...
                    <Box className='banklogo-cont'>
                        <Box><Image className='banklogo' src='https://png.pngitem.com/pimgs/s/23-238440_axis-bank-png-logo-of-axis-bank-transparent.png' alt='Axis' />
                            <Text>AXIS</Text></Box>
                        <Box><Image className='banklogo' src='https://companieslogo.com/img/orig/HDB-bb6241fe.png?t=1633497370' alt='hdfc' />
                            <Text>HDFC</Text></Box>
                        <Box><Image className='banklogo' src='https://i.pinimg.com/originals/ff/d5/31/ffd531a6a78464512a97848e14506738.png' alt='ICICI' />
                            <Text>ICICI</Text></Box>
                        <Box><Image className='banklogo' src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/SBI-logo.svg/240px-SBI-logo.svg.png' alt='SBI' />
                            <Text>SBI</Text></Box>
                        <Box><Image className='banklogo' src='https://companieslogo.com/img/orig/KOTAKBANK.NS-36440c5e.png?t=1593960269' alt='KOTAK' />
                            <Text>KOTAK</Text></Box>
                    </Box>
                    <Select placeholder='Select a Bank' width={'50%'} h='30px' mb='10px' ml='3'>
                            ...
                            <Stack direction='column'>
                                <Radio value='1'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://download.logo.wine/logo/Paytm/Paytm-Logo.wine.png' alt='Paytm' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>Paytm Wallet</Text>
                                    </Box>
                                </Radio>
                                <Radio value='2'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7ih1e58Hb14wPsHUbWoVYF-4jznxuDzDd9Q&usqp=CAU' alt='Ola money' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>OlaMoney Postpaid + Wallet</Text>
                                    </Box>
                                </Radio>
                                <Radio value='3'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9Y2bFIK3LjcUwBJylqP5mgPOL-vnkRwk3Sg&usqp=CAU' alt='Paytm' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>Mobikwik</Text>
                                    </Box>
                                </Radio>
                            </Stack>
                        </RadioGroup>
                    ...
                    <Box ml='10px' >
                        <RadioGroup mt='10px' mb='10px'>
                            <Stack direction='column'>
                                <Radio value='1'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://play-lh.googleusercontent.com/B5cNBA15IxjCT-8UTXEWgiPcGkJ1C07iHKwm2Hbs8xR3PnJvZ0swTag3abdC_Fj5OfnP' alt='Paytm' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>upi</Text>
                                    </Box>
                                </Radio>
                                <Radio value='2'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://images.hindustantimes.com/tech/img/2020/11/05/1600x900/image_-_2020-11-05T095740.083_1604550459365_1604550465218_1604550598928.jpg' alt='Gpay' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>Google Pay</Text>
                                    </Box>
                                </Radio>
                                <Radio value='3'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Image className='wallet-logo' src='https://image01.realme.net/general/20190821/1566357380566.jpg' alt='Paytm' />
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>Mobikwik</Text>
                                    </Box>
                                </Radio>
                            </Stack>
                    ...
                    <Box ml='10px' >
                        <RadioGroup mt='10px' mb='10px'>
                            <Stack direction='column'>
                                <Radio value='1'>
                                    <Box display={'flex'} alignItems='center'>
                                        <Text fontSize={'16px'} fontWeight='500' color={'black'}>Pay on Delivery</Text>
                                    </Box>
                                </Radio>
                            </Stack>
                        </RadioGroup>
